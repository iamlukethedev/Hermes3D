  ...
  return (
    ...
    >
      <group position={[widthWorld / 2, 0, depthWorld / 2]} rotation={[0, rotY, 0]}>
        ...
        <mesh position={[0, 0.95, -depthWorld * 0.1]} castShadow receiveShadow>
        ...
        <group position={[0, 0.6, depthWorld * 0.35]}>
          ...
          {/* Subtle glass overlay in front of the screen. */}
          <mesh position={[0, 0.1, depthWorld * 0.25 + 0.052]} rotation={[-0.2, 0, 0]}>
            <planeGeometry args={[widthWorld * 0.62, 0.23]} />
          ...
          <mesh
            position={[0, -0.15, depthWorld * 0.25 + 0.08]}
            rotation={[0.2, 0, 0]}
            castShadow
            receiveShadow
          >
      ...
      <group position={[widthWorld / 2, 0, depthWorld / 2]} rotation={[0, rotY, 0]}>
        ...
        <group position={[0, 1.2, -depthWorld / 2 + 0.08]}>
          ...
          <mesh position={[0, 0.08, 0.035]}>
            ...
            <meshStandardMaterial color="#0ea5e9" emissive="#0ea5e9" emissiveIntensity={1.8} />
          </mesh>
          {/* Subtle glass overlay in front of the phone display. */}
  ...
  return (
    ...
    >
      <group position={[widthWorld / 2, 0, depthWorld / 2]} rotation={[0, rotY, 0]}>
        ...
        <mesh position={[0, 1.69, 0]} castShadow receiveShadow>
        ...
        <mesh position={[0, 0.88, -depthWorld / 2 + 0.15]} castShadow receiveShadow>
          ...
          <meshStandardMaterial color="#141f38" metalness={0.5} roughness={0.25} />
        </mesh>
        ...
        {/* Subtle glass overlay in front of the SMS display. */}
        <mesh position={[0, 0.9, -depthWorld / 2 + 0.188]}>
          <planeGeometry args={[widthWorld * 0.13, 0.05]} />
          <meshPhysicalMaterial
            color="#ffffff"
            transparent
  ...
  return (
    ...
    >
      <group position={[widthWorld / 2, 0, depthWorld / 2]} rotation={[0, rotY, 0]}>
        ...
        {/* Subtle glass overlay in front of the terminal screen. */}
        <mesh position={[0, 0.46, depthWorld * 0.44 + 0.004]} rotation={[-0.18, 0, 0]}>
          <planeGeometry args={[widthWorld * 0.66, 0.27]} />
          <meshPhysicalMaterial
            color="#ffffff"
            transparent
            opacity={0.15}
        ...
        <mesh position={[0, 0.11, depthWorld * 0.42]} castShadow>
      ...
      <group position={[widthWorld / 2, 0, depthWorld / 2]} rotation={[0, rotY, 0]}>
        ...
        {[-widthWorld * 0.2, widthWorld * 0.2].map((x, index) => (
          <group key={x} position={[x, 0.52, depthWorld * 0.41]} rotation={[-0.16, 0, 0]}>
            ...
            {/* Subtle glass overlay in front of the QA screen. */}
        ...
        <mesh position={[0, 0.16, depthWorld * 0.4]} castShadow>
        ...
        <mesh position={[0, 0.2, depthWorld * 0.44]}>
          ...
          <meshStandardMaterial color="#182132" metalness={0.55} roughness={0.2} />
        </mesh>
        ...
        <mesh position={[widthWorld * 0.36, 0.3, -depthWorld * 0.18]} rotation={[0, -0.3, 0]} castShadow>
    ...
    >
      <group position={[widthWorld / 2, 0, depthWorld / 2]} rotation={[0, rotY, 0]}>
        ...
        <mesh position={[-widthWorld * 0.18, 0.52, 0]}>
          ...
          <meshStandardMaterial color="#182132" />
        </mesh>
        <mesh position={[-widthWorld * 0.18, 0.52, 0.016]}>
          <planeGeometry args={[widthWorld * 0.18, 0.08]} />
          <meshStandardMaterial color="#38bdf8" emissive="#38bdf8" emissiveIntensity={1.7} />
        </mesh>
        ...
        <mesh position={[-widthWorld * 0.36, 0.5, -depthWorld * 0.16]}>
          ...
          <meshStandardMaterial color="#dbe2ea" metalness={0.9} roughness={0.15} />
        </mesh>
        <mesh position={[-widthWorld * 0.31, 0.6, -depthWorld * 0.1]} rotation={[0, 0, -0.7]}>
          <boxGeometry args={[0.12, 0.018, 0.018]} />
          <meshStandardMaterial color="#f0f4f8" metalness={0.9} roughness={0.12} />
        </mesh>
        <Text
          position={[0, 0.64, 0]}
          fontSize={0.034}
...
export function PingPongTableModel({
  ...
  const metal = useMemo(() => getBrushedMetalTextures(), []);
  const fabric = useMemo(() => getFabricTextures(), []);
  ...
  return (
    ...
    >
      <group position={[width / 2, 0, depth / 2]} rotation={[0, rotY, 0]}>
        ...
        <mesh position={[-width * 0.34, 0.21, -depth * 0.3]} castShadow>
  ...
  return (
    ...
    >
      <group position={[widthWorld / 2, 0, depthWorld / 2]} rotation={[0, rotY, 0]}>
        ...
        <mesh position={[-widthWorld * 0.34, 0.4, 0]} castShadow>
  ...
  return (
    ...
    >
      <group position={[widthWorld / 2, 0, depthWorld / 2]} rotation={[0, rotY, 0]}>
        ...
        <mesh position={[-widthWorld * 0.15, 0.18, -depthWorld * 0.22]} rotation={[0, 0, 0.22]} castShadow>
        ...
        <mesh position={[widthWorld * 0.33, 1.1, 0]} castShadow>
          <boxGeometry args={[0.04, 0.04, depthWorld * 0.7]} />
          <meshStandardMaterial color="#e6eaef" metalness={0.95} roughness={0.08} />
        </mesh>
        <mesh position={[widthWorld * 0.33, 1.1, -depthWorld * 0.34]} castShadow>
          <cylinderGeometry args={[0.055, 0.055, 0.05, 18]} />
          <meshStandardMaterial color="#182132" roughness={0.45} metalness={0.6} />
        </mesh>
        <mesh position={[widthWorld * 0.33, 1.1, depthWorld * 0.34]} castShadow>
          <cylinderGeometry args={[0.055, 0.055, 0.05, 18]} />
          <meshStandardMaterial color="#182132" roughness={0.45} metalness={0.6} />
  ...
  return (
    ...
    >
      <group position={[widthWorld / 2, 0, depthWorld / 2]} rotation={[0, rotY, 0]}>
        ...
        <mesh position={[-widthWorld * 0.34, 0.18, 0]} rotation={[0, 0, 0.18]} castShadow>
        ...
        {([-0.26, -0.12, 0.02, 0.16, 0.3] as const).map((offsetX, index) => (
          <group key={index} position={[widthWorld * offsetX, index % 2 === 0 ? 0.32 : 0.54, 0]}>
            <mesh rotation={[Math.PI / 2, 0, 0]} castShadow>
              ...
              <meshStandardMaterial color="#182132" roughness={0.55} metalness={0.6} />
            </mesh>
            <mesh position={[0, 0, depthWorld * 0.1]} rotation={[Math.PI / 2, 0, 0]} castShadow>
              <cylinderGeometry args={[0.028, 0.028, 0.11, 18]} />
              <meshStandardMaterial color="#182132" roughness={0.55} metalness={0.6} />
            </mesh>
          </group>
  ...
  return (
    ...
    >
      <group position={[widthWorld / 2, 0, depthWorld / 2]} rotation={[0, rotY, 0]}>
        ...
        <mesh position={[widthWorld * 0.2, 1.2, depthWorld * 0.02]} castShadow>
          <boxGeometry args={[0.26, 0.06, 0.04]} />
          <meshStandardMaterial color="#e0e6ec" metalness={0.95} roughness={0.08} />
        </mesh>
    ...
    >
      <group position={[widthWorld / 2, 0, widthWorld / 2]} rotation={[0, rotY, 0]}>
        <mesh position={[0, 1.22, 0]} castShadow>
          ...
          <meshStandardMaterial color="#a3b1c2" roughness={0.4} metalness={0.7} />
        </mesh>
        ...
        <mesh position={[0, 1.25, 0]} rotation={[Math.PI / 2, 0, 0]}>
          ...
          <meshStandardMaterial color="#e0e6ec" metalness={0.95} roughness={0.1} />
        </mesh>
        <mesh position={[0, 0.02, 0]} rotation={[-Math.PI / 2, 0, 0]}>
          <ringGeometry args={[0.11, 0.18, 24]} />
          <meshStandardMaterial color="#141f38" roughness={0.92} metalness={0.08} />
        </mesh>
      </group>
    </group>
  );
  ...
  return (
    ...
    >
      <group position={[widthWorld / 2, 0, depthWorld / 2]} rotation={[0, rotY, 0]}>
        ...
        <mesh position={[-widthWorld * 0.24, 0.18, 0]} castShadow>
        ...
        <mesh position={[widthWorld * 0.2, 0.26, 0]} castShadow>
        ...
        <mesh position={[widthWorld * 0.2, 0.26, 0]}>
          ...
          <meshStandardMaterial color="#fb8434" roughness={0.4} metalness={0.1} />
        </mesh>
        <mesh position={[-widthWorld * 0.06, 0.36, 0]} rotation={[0, 0, 0.2]} castShadow>
        ...
        <mesh position={[widthWorld * 0.1, 0.72, 0]} castShadow>
  ...
  return (
    ...
    >
      <group position={[widthWorld / 2, 0, depthWorld / 2]} rotation={[0, rotY, 0]}>
        ...
        <mesh position={[-widthWorld * 0.32, 0.14, 0]} castShadow>
        ...
        {([-0.24, -0.08, 0.08, 0.24] as const).map((offsetX, index) => (
          <group key={index} position={[widthWorld * offsetX, 0.38, 0]}>
            <mesh castShadow>
              ...
              <meshStandardMaterial color="#182132" roughness={0.5} metalness={0.6} />
            </mesh>
            <mesh position={[0, 0.035, 0]}>
              <torusGeometry args={[0.018, 0.005, 10, 18]} />
              <meshStandardMaterial color="#e0e6ec" metalness={0.9} roughness={0.15} />
            </mesh>
          </group>
        ))}
      </group>
  ...
  return (
    ...
    >
      <group position={[widthWorld / 2, 0, depthWorld / 2]} rotation={[0, rotY, 0]}>
        ...
        <mesh position={[0, 0.024, -depthWorld * 0.44]} castShadow>
